# -*- coding: utf-8 -*-
#
# Pulp Docker Support documentation build configuration file, created by modifying a config
...
version = pulp_container.__version__
# The full version, including alpha/beta/rc tags.
release = pulp_container.__version__
